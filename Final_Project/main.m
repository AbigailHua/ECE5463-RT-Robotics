function main()
    ...
    statevar0 = [-pi/4; 0; -pi/4; 0]; % initial conditions for theta1 theta1dot, theta2, theta2dot
    ...
    for i=1:param.n
        ...
        [tlist1,statevarlist1] = ode45(@doublependulumodefile,tspan,statevar0,options,param);
        ...
        statevar0 = [param.td1; 0; param.td2; 0];
    end
