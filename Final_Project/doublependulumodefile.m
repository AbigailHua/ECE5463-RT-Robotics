function dstatevar = doublependulumodefile(t,statevar,param)
    ...
    kp = 100; kv = 80;
%     PD controller
    tau1 = -kp*(theta1-param.td1)-kv*dtheta1;
    tau2 = -kp*(theta2-param.td2)-kv*dtheta2;
    ...
    dstatevar = [dtheta1; ddtheta1; dtheta2; ddtheta2];
